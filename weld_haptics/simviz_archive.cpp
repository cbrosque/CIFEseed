...
const string world_file = "./resources/world3.urdf";
...
Eigen::Vector3d hapticposition2;
...
void simulation(Sai2Model::Sai2Model* robot, Simulation::Sai2Simulation* sim, UIForceWidget *ui_force_widget) {
	...
	while (fSimulationRunning) {
		...
		hapticposition2 << 3+10*hapticposition(0), 1.2+10*hapticposition(2), 10*hapticposition(1);
		redis_client.setEigenMatrixDerived(HAPTIC_POS_KEY, hapticposition2);
