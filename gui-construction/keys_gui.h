...
constexpr const char *POSORI_INTERPOLATION_MAX_LINEAR_VEL = "sai2::examples::posori_interpolation_max_linear_vel";
constexpr const char *POSORI_INTERPOLATION_MAX_LINEAR_ACCEL = "sai2::examples::posori_interpolation_max_linear_accel";
constexpr const char *POSORI_INTERPOLATION_MAX_LINEAR_JERK = "sai2::examples::posori_interpolation_max_linear_jerk";
constexpr const char *POSORI_INTERPOLATION_MAX_ANGULAR_VEL = "sai2::examples::posori_interpolation_max_angular_vel";
constexpr const char *POSORI_INTERPOLATION_MAX_ANGULAR_ACCEL = "sai2::examples::posori_interpolation_max_angular_accel";
constexpr const char *POSORI_INTERPOLATION_MAX_ANGULAR_JERK = "sai2::examples::posori_interpolation_max_angular_jerk";
...
constexpr const char *JOINT_INTERPOLATION_MAX_VEL = "sai2::examples::joint_interpolation_max_vel";
constexpr const char *JOINT_INTERPOLATION_MAX_ACCEL = "sai2::examples::joint_interpolation_max_accel";
constexpr const char *JOINT_INTERPOLATION_MAX_JERK = "sai2::examples::joint_interpolation_max_jerk";
